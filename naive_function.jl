...
function affecte_quai_train(trains)
  #NG = nombbre de groupes
...
function itineaire_admissible_groupe(G)
  ...
  if not(itineaires_admissibles)
    ...
    G = affecte_itineraire_train("Notaffected", G)
  end
  return G
end


function contrainte2(trains)
